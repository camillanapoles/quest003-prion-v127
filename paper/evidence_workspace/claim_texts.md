...
- **C054** (1-met,method) [E009;E010;E031;E032;E033;E007]: ACP - Antecipação Computacional Parametrizada (Parameterized Computational Anticipation): the named research method for continuing research by simulation in current days, comprising P0 identification of published validated data, P1 parametrization with declared provenance, P2 deterministic audited execution, P3 harvest under pre-declared criteria, P4 prognosis locked before any measurement, P5 derived research proceeding immediately from reasonable simulated values, and P6 optional confrontation where analogous real results mean subsequent steps are already advanced - anticipation banked, never pending validation