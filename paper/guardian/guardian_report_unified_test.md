...
**Rodadas executadas:** 3 · **Achados:** 7 (BLOCKED=0, AMEND=0, NOTE=7)
...
- **Problema:** Claims registradas mas não citadas no manuscrito: C001, C002, C004, C006, C007, C008, C009, C010, C011, C012, C017, C018, C019, C020, C021, C022, C023, C025, C026, C027, C028, C029, C030, C031, C040, C041, C042, C043, C044, C045, C048, C049, C050.
- **Exigência:** Confirmar que são intencional (claims de outline/suplemento).

### [NOTE] R1-BATTERY-factual — claims
- **Problema:** Bateria hostil aplicada a 6 claims factual: Status de revisão por pares da fonte? (preprint ≠ revisado — rotular) | Fonte única ou corroboração independente? | Transferência de espécie/modelo → humano declarada? (IDs: C003, C005, C013, C014, C016, C024)
...
- **Problema:** Bateria hostil aplicada a 15 claims result: Pre-registrado ou post-hoc? (rotular explicitamente) | Baseline e critério de comparação definidos? | Incerteza/IC reportado? (IDs: C032, C033, C034, C035, C036, C037, C038, C039, C051, C055, C056, C057, C058, C059, C060)
- **Exigência:** Cada pergunta deve ter resposta no texto/manifesto; sem resposta → limitação.
