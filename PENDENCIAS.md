...
<!-- LEDGER-RESUMO total=26 abertas=20 planejadas_agente=6 fechadas=5 dormant=1 -->
...
| P-024 | - | Fase 2 P3: `p024-multispecies.yml` GHA-matrix por espécie (κ-sweep × bandas × 2 pareamentos; escape-flag; totalf+slope; C0 por job) {{DEFER:spec travada em COMPUTE_EVAL.md §2 (audit recs 1-3 incorporadas); predição hamster comparada ao release}} | AGENTE | PLANEJADA | paper/guardian/COMPUTE_EVAL.md | PLAN_PARTE3 §3 F2 + S3_DATA_AUDIT |
