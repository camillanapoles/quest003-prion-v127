...
| P-024 | - | Fase 2 P3: `p024-multispecies.yml` GHA-matrix 4 espécies — **EM EXECUÇÃO no cloud** (defs pré-registradas no driver: escape-flag≥2,80 · κ_min c/ R≤0,90mm · θ\*=1/(1+κ_min) · pareamento próprio · C0/job) | AGENTE | EM_EXECUCAO | .github/workflows/p024-multispecies.yml | COMPUTE_EVAL §2 |
