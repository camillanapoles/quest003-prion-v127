...
Progresso: **c01 ✓ c02 ✓ c03 ✓** (3/17) · folder único: `escrita-zero/`
...
`fila_hostil.json` (revisor hostil: 14 itens, 12 fechados) · rascunhos-fonte em `../rascunhos/`.

Ciclo por capítulo: brief → escrita → write-guard → 3 gates → persona hostil → emenda/resposta → render → fila versionada → commit.
