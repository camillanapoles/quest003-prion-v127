...
from thesis_engine.models import AcaoDevedora
...
def test_aprova_bloqueada_por_acao_pendente_no_local():
    ...
    # no DB v2 real: ações pendentes vivem em c15/c00/c03 — c04 livre → aprova
    r = hostil_aprova(V2_DB, "c04")
    assert r["aprova"] is True and not r["acoes_pendentes_no_local"]
