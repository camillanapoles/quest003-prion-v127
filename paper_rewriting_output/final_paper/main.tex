...
\begin{figure}[htbp]
\centering
\pandocbounded{\includegraphics[width=0.9\textwidth,keepaspectratio]{../../paper/latex/figs/fig4_theta_species.png}}
...
canônico \texttt{experiments/m31/m31\_u1u2.json} {[}58{]}):} κ\_req
...
de Aβ42 ligando PrP humano {[}57{]} --- \textbf{proxy declarado}, pois o
par V127↔PrP\^{}Sc não tem Kd medido; o teto, 1 µM, é a âncora
...
\begin{figure}[htbp]
\centering
\pandocbounded{\includegraphics[width=0.9\textwidth,keepaspectratio]{../../paper/latex/figs/fig5_dose_ladder.png}}
