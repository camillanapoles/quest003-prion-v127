...
\{\{TODO:TESE-FICHA:programa/área/orientadora/coorientadora ---
preencher após leitura\}\} \textbf{PROGRAMA DE PÓS-GRADUAÇÃO:}
...
dimensional de dose κ→µM→µg/depósito em banda GUM Tipo-B com critérios
de aceitação pré-registrados. \textbf{Resultados.} Limiar θ*=0,333
{[}claim:C038{]} {[}evidence:E032{]}; três regras de design; Cenário B
multi-espécie (θ* 0,333--0,400 centrais; razão 1,20) com regra de
titulação κ↔Kt {[}claim:C055, C057{]} {[}evidence:E032{]}; banda de dose
A6 no degrau humano: 0,0--2,6 µg de V127ΔGPI por depósito (pior caso
κ=8: 0,2--10,3 µg; redose ≤7 d; MW 22,83 kDa das sequências próprias)
--- a largura da banda ≈53× é o achado, dominada pelo proxy de Kd, até o
braço G0-A6 fechá-la {[}claim:C058--C060{]} {[}evidence:E057, E058{]};
registro de 60 claims, 58 fontes, 65 fatos numéricos com validação por
...
banda GUM via Kd aparente --- fechada pelo braço A6) · \textbf{κ\_req}
--- κ requerido para contenção numa banda-Kt dada (regra de titulação) ·
\textbf{Kt} --- classe de taxas de autocatálise/templating (a única que
governa contenção e relógio --- F-43) · \textbf{banda-Kt} --- faixa de
cinética do hospedeiro (humano: \{0,5·1·2\}) · \textbf{MW} --- massa
molecular (PrP maduro humano: 22,83 kDa, computada das sequências
próprias) · \textbf{Damköhler} --- razão
...
\hypertarget{capuxedtulo-1-nota-introdutuxf3ria-uxe0-banca}{%
...
\hypertarget{o-que-a-palavra-uxe9-e-o-que-nomeia-que-nada-mais-nomeia}{%
...
\hypertarget{diferenciauxe7uxe3o-estrutural-o-que-a-banca-deve-testar}{%
...
\hypertarget{capuxedtulo-2-base-comum-de-dados-a-ponte-entre-fundamento-e-aplicauxe7uxe3o}{%
...
\hypertarget{a-mesma-base-sob-os-dois-muxf3dulos}{%
...
\hypertarget{cronologia-honesta-o-examinador-hostil-perguntaria-respondemos-antes}{%
...
\hypertarget{tabela-de-validauxe7uxe3o-todos-os-nuxfameros-dos-jsons-do-registro}{%
...
\hypertarget{capuxedtulo-3-fundamento-a-inariuxe2ncia-de-ux3b8-validauxe7uxe3o-multi-espuxe9cie}{%
...
\hypertarget{do-sweep-de-composiuxe7uxe3o-uxe0-parametrizauxe7uxe3o-por-espuxe9cie}{%
...
\hypertarget{regra-de-titulauxe7uxe3o-emergente}{%
...
\hypertarget{dependuxeancia-de-horizonte-a-uxfanica-assimetria-real}{%
...
\begin{figure}
\centering
\includegraphics{../../paper/latex/figs/fig4_theta_species.png}
...
\hypertarget{capuxedtulo-4-aplicauxe7uxe3o-o-desenho-terapuxeautico-emerge}{%
...
\hypertarget{transporte-truxeas-regras-falseuxe1veis-sim}{%
...
\hypertarget{o-limiar-travado-e-a-dose-legitimada-pela-banda}{%
...
extremos; a largura da banda dominada pelo elo κ↔µM é resultado válido e
esperado; saída de planejamento, jamais prescrição).

\hypertarget{a-primeira-dose-calculada-banda-de-dose-do-brauxe7o-a6-sim-planejamento}{%
...
titulação, C057) → concentração no pico do depósito c = κ\_req × Kd
(banda Kd aparente \textbf{0,071--1,0 µM}: piso = 71 nM medido por SPR
para oligômeros de Aβ42 ligando PrP humano {[}evidence:E057{]} --- proxy
declarado, pois V127↔PrP\^{}Sc não tem Kd medido; teto = âncora
ilustrativa 1 µM da Parte 1 §2.2) → quantidade por depósito n = c ×
V\_halo (V = cilindro r×h com r₁₀\%=4--6 mm {[}evidence:E030{]}, fração
ECS 0,15--0,25 {[}evidence:E010{]}, casca 2 mm declarada Tipo-B) → massa
= n × MW (\textbf{22,83 kDa}, computada das nossas próprias sequências
P04156 --- resíduos 23--231, forma madura; V127 é variante de mesma
massa, Δ=+14 Da) {[}evidence:E058{]}.

\textbf{Escada de dose por banda-Kt do hospedeiro:}
...
\textbf{3,7× do volume do halo} (4--6 mm; ECS 0,15--0,25)
{[}claim:C060{]} {[}evidence:E057, E058, E010, E030{]}. Isto não é
defeito do cálculo: é a \textbf{quantificação honesta do que o ensaio
G0-A6 fecha} --- o braço de proteína recombinante a dose conhecida
converte a âncora κ↔µM de ilustrativa em medida, colapsando a banda em
ponto. Até lá, a dose existe como banda, e a banda é planejamento
{[}SIM{]}: prognóstico calculado, \textbf{não prescrição}.

\begin{figure}
\centering
\includegraphics{../../paper/latex/figs/fig5_dose_ladder.png}
...
(proteína recombinante) tem \textbf{dose conhecível de saída} --- é o
braço discriminador que fecha κ↔µM e testa a forma funcional do capping
(primeira potência vs quadrática, travada na colheita {[}SIM{]} da Parte
1) {[}claim:C051{]} {[}evidence:E032, E033{]}. A5 e A7 herdam a cadeia
como derivadas.

\hypertarget{o-ensaio-que-fecha-a-banda-g0-wet-especificado}{%
...
\hypertarget{custo-cotauxe7uxe3o}{%
...
\hypertarget{capuxedtulo-5-muxe9todos-a-etrizauxe7uxe3o-formalizada}{%
\section{CAPÍTULO 5 --- MÉTODOS: A ETRIZAÇÃO
FORMALIZADA}\label{capuxedtulo-5-muxe9todos-a-etrizauxe7uxe3o-formalizada}}

\hypertarget{o-muxe9todo-nomeado-etrizauxe7uxe3o-computacional-passos-p0p6}{%
...
A \textbf{parametrização} (operação técnica do P1) é o núcleo
operacional; a \textbf{tese etrizada} é o produto {[}claim:C054{]}
{[}evidence:E009, E010, E007, E031, E032, E033{]}. Declaração de eixo
...
\hypertarget{formulauxe7uxe3o-matemuxe1tica-com-proveniuxeancia}{%
...
\hypertarget{base-de-validade-mandatuxf3ria}{%
...
\hypertarget{a-tese-em-forma-experimental-mapeamento-anuxe1logo}{%
...
\hypertarget{capuxedtulo-6-resultados-como-validauxe7uxe3o}{%
...
\hypertarget{capuxedtulo-7-camada-cluxednica}{%
\section{CAPÍTULO 7 --- CAMADA
CLÍNICA}\label{capuxedtulo-7-camada-cluxednica}}
...
aqui orienta conduta, dose ou seleção de paciente.
\end{quote}
...
faria:} (1) \textbf{Que doença?} DCJ esporádica/genética: rapidamente
progressivas, 100\% fatais, seis candidatos já faliram. (2) \textbf{Que
ideia?} A variante PrP-G127V --- selecionada pela evolução (kuru) ---
como agente dominante-negativo: compete com o príon e trava a replicação
sem silenciar o PrP nativo. (3) \textbf{Que evidência?} Nenhuma medição
nova em pacientes: simulação parametrizada com dados reais publicados
(etrização); predições travadas ANTES de qualquer medição. (4)
\textbf{Que resultado prático?} Três regras quantitativas (anel 8--12
mm; redose ≤7 d; limiar θ*≈⅓) + a sondagem multi-espécie (limiar
aproximadamente conservado; dose titulada à velocidade da doença) +
\textbf{a primeira dose calculada do braço A6: banda de 0,0--2,6 µg de
proteína por depósito no degrau humano (pior caso 0,2--10,3), com a
largura da banda explicitando o que o ensaio organoide fecha}. (5)
\textbf{Que promessa NÃO faz?} Não promete cura, aplicação humana, nem
substitui laboratório.

\textbf{Como ler os símbolos sem perder o fio:} θ* = ``quanto da
conversão sobrevive à dose no pior dia do anel'' (⅓ ≈ contém); κ = a
dose; Kt = a velocidade inerente da doença. Cada capítulo técnico abre
com ``Em linguagem clínica''.

\textbf{Rota de leitura de 10 minutos:} (1) esta NOTA (3 min) → (2)
\textbf{Figura 4} (dose-limiar por espécie; 2 min) → (3) \textbf{Figura
5} (escada de dose com a banda; 2 min) → (4) §8 ``o que significam e o
que não significam'' (2 min) → (5) Cap. 9 conclusões (1 min).

\textbf{Acompanhamento previsto no desenho {[}SIM{]} (documentação de
desenho --- NÃO conduta clínica):} θ\_obs em readouts 90--120 d (perfis
radiais WB/IHC com leitura cega; critério θ\_obs\textless0,33
pré-registrado); manutenção da cobertura secretora com redose ≤7 d
(gradiente proximal/distal; trough ≥30--56\% {[}SIM{]}); triagem
pré-sintomática na população-âncora E200K (RT-QuIC + NfL; precedentes
tofersen/nusinersen). Serviços de neurologia interessados em auditar ou
viabilizar o próximo gate encontram o pacote em
\texttt{paper/G0\_UNLOCK\_DOSSIER.md} +
\texttt{paper/lab\_outreach\_package.md}.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{capuxedtulo-8-limitauxe7uxf5es-como-fruto-cada-limite-com-o-que-o-fecha}{%
...
é proxy (Kd de Aβ42-oligômero↔PrP {[}E057{]}, não V127↔PrP\^{}Sc):
\textbf{a banda de dose inteira (largura ≈53×) quantifica este limite}
{[}claim:C060{]} --- fechada pelo braço A6 (dose conhecida). 3. Sem dado
...
\hypertarget{capuxedtulo-9-conclusuxf5es-por-objetivo}{%
...
completa (agora 7 linhas, incluindo a âncora κ↔µM em banda)
{[}claim:C046{]}.
...
\hypertarget{referuxeancias-58-fontes-do-registro}{%
...
\emph{(Kd aparente 71 nM por SPR --- proxy declarado da âncora κ↔µM;
texto integral conferido.)} {[}58{]} OPEN PRION \& MOLECULAR
ENGINEERING, CONSORTIUM. M3.1: dose-chain κ\_req→µM→µg/deposit with GUM
Type-B band + PrP MW from own sequences (this program). 2026. Disponível
em: https://github.com/camillanapoles/quest003-prion-v127. \emph{(JSON:
\texttt{experiments/m31/m31\_u1u2.json}.)}

\hypertarget{fontes-complementares-verificauxe7uxe3o-completa-pendente-snippet-level}{%
