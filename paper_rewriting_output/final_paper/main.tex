...
\begin{quote}
\textbf{NOTA À LEITURA --- SOBRE O TERMO \emph{ETRIZAÇÃO}}
...
\chapter*{LISTA DE SIGLAS}\addcontentsline{toc}{chapter}{LISTA DE SIGLAS}\label{lista-de-siglas}}
...
\hypertarget{nota-introdutuxf3ria-uxe0-banca}{%
...
\begin{quote}
\textbf{PRODUTO FINAL --- ESTA É A TESE (declaração de abertura)}
...
murina publicada, dados de organoide humano publicados, parâmetros de
transporte humano in-vivo, código aberto --- \textbf{parametrizados para
humanos e executados em ambiente simulado}, o que garante
\textbf{aproximação e expectativa quantitativas} (prognóstico falseável)
sem reivindicar medição. As claims são reais e registry-bound; o
ambiente é simulado; a tese é o produto. \textbf{Guardião-2 atesta} como
revisor hostil nas quatro dimensões: metodologia, dados, conformidade e
conteúdo.
\end{quote}
...
\hypertarget{fundamentauxe7uxe3o}{%
...
\hypertarget{base-comum-de-dados-a-ponte-entre-fundamento-e-aplicauxe7uxe3o}{%
...
\hypertarget{fundamento-a-inariuxe2ncia-de-ux3b8-validauxe7uxe3o-multi-espuxe9cie}{%
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{../../paper/latex/figs/fig4_theta_species.png}
...
\hypertarget{aplicauxe7uxe3o-o-desenho-terapuxeautico-emerge}{%
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{../../paper/latex/figs/fig5_dose_ladder.png}
...
\hypertarget{muxe9todos-a-etrizauxe7uxe3o-formalizada}{%
...
\bottomrule\noalign{}
\endlastfoot
Cinética de replicação & Fornara/Igel 2024 (aberto) & camundongo & Masel
1999 & kernel portado & relógio às âncoras humanas & θ*=0,333
{[}C038{]} \\
Relógio/amplitude humanos & Groveman 2019 & organoide sCJD & Groveman
2021; subtipos 2023 & regressão 12,1 d; 144 d/unid & direto & predição
θ\textless0,33 {[}C040{]} \\
Transporte intersticial & Thorne \& Nicholson 2006 & humano in-vivo &
Stokes--Einstein & solver ADR auto-testado & direto & regras 1--3
{[}C033-C035{]} \\
Agente V127 anchorless & Asante 2015 · Gatdula 2026 · Zerbes 2026 &
população→camundongo→cultura→AAV & quatro níveis independentes & termo
freeS & dose↔κ em banda (seção 6.3) & contenção κ=2 {[}C038{]} \\
Âncora κ↔µM (banda) & Chen 2010 SPR + âncora ilustrativa P1 seção 4.2 &
humano (Aβ42-PrP; PROXY declarado) & --- & cadeia dimensional M3.1 &
direto & banda A6 0,0--2,6 µg {[}C058-C060{]} \\
...
\hypertarget{resultados-como-validauxe7uxe3o-componentes-m1m5}{%
...
\hypertarget{achados-impactos-e-uxe1reas-correlatas-pruxf3ximas-abordagens}{%
...
\hypertarget{camada-cluxednica-pruxe9-abordagem-dos-temas-antes-da-penetrauxe7uxe3o-tuxe9cnica}{%
...
\hypertarget{limitauxe7uxf5es-como-fruto-cada-limite-com-o-que-o-fecha}{%
...
\hypertarget{conclusuxf5es-por-objetivo}{%
